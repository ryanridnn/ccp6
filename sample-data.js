...
const JOB_1 = {
  ...
  preset: {
    ...
    items: [
      mkFCItem({ sku: "SQZJ19", desc: "APP TUNA BALL / CABBAGE ROLL", cls: "BC", qty: 24 }, { status: "NotStarted", startTemp: 4.5 }),
      mkFCItem({ sku: "SQZJ19", desc: "CAMEMBERT / KUMQUAT / PROSCIUTTO", cls: "BC", qty: 24 }, { status: "NotStarted", startTemp: 4.7 }),
      mkFCItem({ sku: "SQZJ19", desc: "DES MANGO MOUSSE", cls: "BC", qty: 48 }, { status: "NotStarted", startTemp: 4.9 }),
      mkFCItem({ sku: "SQZJ19", desc: "BRSD CHICK W SICHUAN CHILLI SCE", cls: "EY", qty: 160 }, { status: "NotStarted", startTemp: 5.1 }),
    ],
    traysHandled: 256,
    staffCount: 6,
  },
...
const JOB_2 = {
  ...
  preset: {
    ...
    items: [
      mkFCItem({ sku: "SQZJ19", desc: "EGG WHITE OMELETTE / TOAST", cls: "BC", qty: 120 }, { status: "NotStarted", startTemp: 3.8 }),
      mkFCItem({ sku: "SQZJ19", desc: "BUTTERMILK PANCAKE STACK", cls: "BC", qty: 36 }, { status: "NotStarted", startTemp: 4.2 }),
      mkFCItem({ sku: "SQZJ19", desc: "FRESH FRUIT BOWL", cls: "BC", qty: 120 }, { status: "NotStarted", startTemp: 4.5 }),
      mkFCItem({ sku: "SQZJ19", desc: "SMOKED SALMON BAGEL", cls: "EY", qty: 36 }, { status: "NotStarted", startTemp: 4.8 }),
    ],
    traysHandled: 180,
    staffCount: 5,
  },
...
const JOB_3 = {
  ...
  preset: {
    ...
    items: [
      mkFCItem({ sku: "SQZJ19", desc: "BEEF RENDANG / JASMINE RICE", cls: "BC", qty: 144 }, { status: "NotStarted", startTemp: 4.1 }),
      mkFCItem({ sku: "SQZJ19", desc: "PAN SEARED SALMON", cls: "BC", qty: 60 }, { status: "NotStarted", startTemp: 4.4 }),
      mkFCItem({ sku: "SQZJ19", desc: "TIRAMISU CUP", cls: "BC", qty: 144 }, { status: "NotStarted", startTemp: 4.6 }),
      mkFCItem({ sku: "SQZJ19", desc: "GRILLED VEGETABLE PLATE", cls: "EY", qty: 60 }, { status: "NotStarted", startTemp: 5.0 }),
    ],
    traysHandled: 300,
    staffCount: 8,
  },
...
const JOB_5 = {
  ...
  preset: {
    ...
    complianceResult: null,
    items: [
      mkFCItem({ sku: "SQZJ19", desc: "JAPANESE CHICKEN TERIYAKI", cls: "BC", qty: 108 }, { status: "NotStarted", startTemp: 4.0 }),
      mkFCItem({ sku: "SQZJ19", desc: "TAMAGO SUSHI ROLL", cls: "BC", qty: 108 }, { status: "NotStarted", startTemp: 4.3 }),
      mkFCItem({ sku: "SQZJ19", desc: "MISO SOUP", cls: "BC", qty: 108 }, { status: "NotStarted", startTemp: 4.7 }),
      mkFCItem({ sku: "SQZJ19", desc: "EDAMAME", cls: "EY", qty: 108 }, { status: "NotStarted", startTemp: 5.2 }),
    ],
  },
  foodChecker: {
    status: "NotStarted",
